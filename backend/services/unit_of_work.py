...
import services.equipment.infra.equipment_repository as equipments_repo
import services.case.infra.case_repository as cases_repo


class AbstractUnitOfWork(ABC):
    equipments_repo: equipments_repo.AbstractEquipmentsRepository
    cases_repo: cases_repo.AbstractCaseRepository
...
class DbPoolUnitOfWork(AbstractUnitOfWork):
    ...
    def __enter__(self):
        ...
        self.cases_repo = cases_repo.CaseRepository(self.db_pool)
